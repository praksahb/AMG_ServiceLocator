...
namespace ServiceLocator.Sound
{
    public class SoundService
    {
        ...
        public SoundService(SoundScriptableObject soundScriptableObject, AudioSource bgSource, AudioSource sfxSource)
        {
            this.soundScriptableObject = soundScriptableObject;
            this.backgroundMusic = bgSource;
            this.audioEffects = sfxSource;
